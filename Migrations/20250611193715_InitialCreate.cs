    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SitaContracts", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "SitaTeamMembers",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SitaTeamMembers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_Resolutions_ResolutionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AffectedEndUser = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    PositionLocation = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ResolutionId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tickets", x => x.IncidentNumber);
                    table.ForeignKey(
                        name: "FK_Tickets_Resolutions_ResolutionId",
                        column: x => x.ResolutionId,
                        principalTable: "Resolutions",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Notes_SitaContracts_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "SitaContracts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HowToSteps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HowToSteps_HowTos_HowToId",
                        column: x => x.HowToId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_ResolutionId",
                table: "Comments",
                column: "ResolutionId");

            migrationBuilder.CreateIndex(
                name: "IX_HowTos_CompanyId",
                table: "HowTos",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_HowTos_CreatedById",
                table: "HowTos",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_HowToSteps_HowToId",
                table: "HowToSteps",
                column: "HowToId");
